...
@interface QualityViewController () <UIScrollViewDelegate>
...
- (void)setChildViewController{
    MyRecordTableViewController *myRecordVC = [[MyRecordTableViewController alloc] init];
    FamilyListTableViewController *familyListVC = [[FamilyListTableViewController alloc] init];
    
    [self addChildViewController:myRecordVC];
    [self addChildViewController:familyListVC];
}
