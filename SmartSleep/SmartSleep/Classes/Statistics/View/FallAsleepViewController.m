...
#import "PNChart.h"
@interface FallAsleepViewController ()

@property (nonatomic) PNLineChart * lineChart;
@end

@implementation FallAsleepViewController
...
-(void)setupChartLine {
    ...
    [self.lineChart setYLabels:@[@"0分钟",@"20分钟",@"40分钟",@"60分钟",@"80分钟",@"100分钟",@"120分钟"]];
    
    // Line Chart #1
    NSArray * data01Array = @[@30, @60, @30, @10, @30];
    PNLineChartData *data01 = [PNLineChartData new];
    data01.dataTitle = @"入睡时长";
