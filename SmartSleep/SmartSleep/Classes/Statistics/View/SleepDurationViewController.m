...
#import "PNChart.h"
@interface SleepDurationViewController ()

@property (nonatomic) PNLineChart * lineChart;
@end

@implementation SleepDurationViewController
...
-(void)setupChartLine {
    ...
    //Only if you needed
    self.lineChart.yFixedValueMax = 12.0;
    self.lineChart.yFixedValueMin = 0.0;
    
    [self.lineChart setYLabels:@[@"0小时",@"2小时",@"4小时",@"6小时",@"8小时",@"10小时",@"12小时"]];
    
    // Line Chart #1
    NSArray * data01Array = @[@9, @8.3, @8, @9, @9];
    PNLineChartData *data01 = [PNLineChartData new];
    data01.dataTitle = @"睡眠时长";
