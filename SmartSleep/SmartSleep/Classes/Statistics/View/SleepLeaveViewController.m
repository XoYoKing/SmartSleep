...
#import "PNChart.h"
@interface SleepLeaveViewController ()

@property (nonatomic) PNLineChart * lineChart;
@end

@implementation SleepLeaveViewController
...
-(void)setupChartLine {
    ...
    //Only if you needed
    self.lineChart.yFixedValueMax = 20.0;
    self.lineChart.yFixedValueMin = 0.0;
    
    [self.lineChart setYLabels:@[@"0次",@"5次",@"10次",@"15次",@"20次"]];
    
    // Line Chart #1
    NSArray * data01Array = @[@0, @2, @0, @0, @0];
    PNLineChartData *data01 = [PNLineChartData new];
    data01.dataTitle = @"离床次数";
