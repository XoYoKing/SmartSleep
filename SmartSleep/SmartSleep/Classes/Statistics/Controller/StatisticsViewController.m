...
- (void)setChildViewController{
    ...
    FamilyReportViewController *familyReportVC = [[FamilyReportViewController alloc] init];
    
    [self addChildViewController:myReportVC];
    [self addChildViewController:familyReportVC];
}
